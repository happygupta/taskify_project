...
class _CompletedscreenState extends State<Completedscreen> {
  ...
  void markAsCompleted(String id) async{
    await FirebaseFirestore.instance.collection('Details').doc(id).update({'status':"pending"});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Complete Events'),
        centerTitle: true,
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("Details").where('status',isEqualTo: 'Completed').snapshots(),
